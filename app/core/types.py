...
class TelemetryLogRecord(BaseModel):
    ...
    # Provider routing + persona trace (captures recent changes)
    model_provider: Optional[str] = Field(default=None, description="Selected provider for the request.")
    model_selected: Optional[str] = Field(default=None, description="Final model used for synthesis (if available).")
    reranker_model_name: Optional[str] = Field(default=None, description="Reranker model name used, if any.")
    retrieval_scope: Optional[str] = Field(default=None, description="Retrieval scope decision: kb_only/session_only/both.")
    active_persona: Optional[str] = Field(default=None, description="Injected persona name, if any.")
    stream_enabled: bool = Field(default=False, description="Whether SSE streaming was enabled for the response.")
